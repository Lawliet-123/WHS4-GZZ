...
namespace sdk
{
    namespace FieldOffsets
    {
        ...
        // The current BP pawn has no stable reflected RuntimePaintable pointer;
        // resolve the component dynamically instead of reading an unrelated field.
        constexpr std::uintptr_t BP_FirstPersonCharacter_RuntimePaintable = 0x0000;
    ...
    static_assert(offsetof(RuntimePaintableComponent_InitializePaint, ReturnValue) == 0x08,
                  "InitializePaint return layout mismatch");

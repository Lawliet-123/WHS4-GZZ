...
namespace sdk
{
    namespace FieldOffsets
    {
        ...
        constexpr std::uintptr_t BP_FirstPersonCharacter_RuntimePaintable = 0xB58;
    ...
    struct FRuntimeBrushSettings
    {
        ...
        float Opacity{1.0f};
        float Spacing{0.25f};
        EBrushFalloff Falloff{EBrushFalloff::Round};
    ...
    struct FCompactPaintStroke
    {
        ...
        std::uint8_t Pad_16[0x2]{};
        FColor EmissiveColor{};
        EPaintChannel TargetChannel{EPaintChannel::Albedo};
        std::uint8_t Pad_1D[0x3]{};
        float EffectiveBrushWorldRadius{0.02f};
        std::uint8_t EffectiveSubdivisionLevel{0};
        std::uint8_t Pad_25[0x3]{};
        float EffectiveSubdivisionPixelSize{1.0f};
        std::int32_t EffectiveTemplateResolution{0};
        FGuid ReplicationSourceId{};
    };
    ...
    static_assert(offsetof(FPaintStroke, EffectiveSubdivisionLevel) == 0xBC, "PaintStroke EffectiveSubdivisionLevel offset mismatch");
    ...
    static_assert(sizeof(FCompactPaintStroke) == 0x40, "CompactPaintStroke layout mismatch");
    ...
    static_assert(offsetof(FCompactPaintStroke, EmissiveColor) == 0x18, "CompactPaintStroke EmissiveColor offset mismatch");
    static_assert(offsetof(FCompactPaintStroke, TargetChannel) == 0x1C, "CompactPaintStroke TargetChannel offset mismatch");
    static_assert(offsetof(FCompactPaintStroke, EffectiveBrushWorldRadius) == 0x20, "CompactPaintStroke EffectiveBrushWorldRadius offset mismatch");
    static_assert(offsetof(FCompactPaintStroke, EffectiveSubdivisionLevel) == 0x24, "CompactPaintStroke EffectiveSubdivisionLevel offset mismatch");
    static_assert(offsetof(FCompactPaintStroke, EffectiveSubdivisionPixelSize) == 0x28, "CompactPaintStroke EffectiveSubdivisionPixelSize offset mismatch");
    static_assert(offsetof(FCompactPaintStroke, EffectiveTemplateResolution) == 0x2C, "CompactPaintStroke EffectiveTemplateResolution offset mismatch");
    static_assert(offsetof(FCompactPaintStroke, ReplicationSourceId) == 0x30, "CompactPaintStroke ReplicationSourceId offset mismatch");
